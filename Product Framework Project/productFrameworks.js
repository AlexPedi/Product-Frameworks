...
var btnContainer = document.getElementById("items");
...
(function() {
    ...
    for (var i = 0; i < s.length; i++) {
            if (s[i].nodeName == 'SCRIPT' &&
                s[i].attributes['src'] &&
                s[i].attributes['src'].nodeValue == unescape('\x2F\x2Fcse.google.com\x2Fcse\x2Fbrand?form=cse-search-box-form-id\x26inputbox=cse-search-input-box-id')) {
              append = true;
              break;
            }
          }
